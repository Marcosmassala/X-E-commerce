    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800">
          <h2 className="text-xl font-semibold text-white mb-6">Bem-vindo de volta</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="lembrar" className="ml-2 text-xs text-zinc-400">
                  Lembrar acesso
                </label>
              </div>
            ...
            <button
              type="submit"
              className="w-full bg-green-500 text-black font-medium py-2.5 px-4 rounded-lg hover:bg-green-400 transition focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-black"
            >
              Entrar
            </button>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg hover:bg-zinc-700 transition">
