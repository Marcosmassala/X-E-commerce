...
export default function FilterSidebar({
  ...
  <input
    ...
    className="peer h-5 w-5 cursor-pointer appearance-none rounded-md border-2 border-gray-300 checked:border-green-500 checked:bg-green-500 transition-all duration-200 hover:border-green-400 hover:shadow-sm focus:ring-2 focus:ring-green-300 focus:ring-opacity-50 focus:outline-none"
  />
  <svg
